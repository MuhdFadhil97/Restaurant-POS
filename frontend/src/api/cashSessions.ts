...
export function useCurrentCashSession(outletId?: string) {
  return useQuery({
...
export function useCashSessions(outletId?: string) {
  return useQuery({
...
export function useOpenCashSession() {
  ...
  return useMutation({
    mutationFn: async (input: { outletId: string; openingCash: number }) =>
...
export function useCloseCashSession() {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async ({ id, actualCash }: { id: string; actualCash: number }) =>
